...
const groupKeywords = {
  ...
  "People & Body": {
    ko: "사람 몸 제스처 인물 가족 직업",
    en: "people body gesture person family job",
    ja: "人 体 ジェスチャー 人物 家族 職業",
    zh: "人 身体 手势 人物 家庭 职业",
  },
  "Animals & Nature": {
    ko: "동물 자연 식물 날씨",
...
const wordKeywords = {
  ...
  finger: ["손가락", "指", "手指"],
  fingers: ["손가락", "指", "手指"],
  index: ["검지 손가락", "人差し指 指", "食指 手指"],
  middle: ["가운데 손가락 중지", "中指 指", "中指 手指"],
  thumb: ["엄지 손가락", "親指 指", "拇指 手指"],
  thumbs: ["엄지 손가락", "親指 指", "拇指 手指"],
  pointing: ["가리키기 손가락", "指差し 指", "指向 手指"],
  pinched: ["꼬집기 손가락", "つまむ 指", "捏 手指"],
  crossed: ["교차 손가락", "交差 指", "交叉 手指"],
  victory: ["브이 손가락 승리", "ピース 指 勝利", "胜利 手指"],
  backhand: ["손등 손가락", "手の甲 指", "手背 手指"],
  raised: ["올린 손", "上げた手", "举手"],
  folded: ["모은 손 기도", "合わせた手 祈り", "合十 祈祷"],
  waving: ["손 흔들기", "手を振る", "挥手"],
  clapping: ["박수 손", "拍手", "鼓掌"],
  person: ["사람", "人", "人"],
  man: ["남자", "男性", "男人"],
  woman: ["여자", "女性", "女人"],
  baby: ["아기", "赤ちゃん", "婴儿"],
  family: ["가족", "家族", "家庭"],
  skin: ["피부색 피부", "肌 肌色", "肤色 皮肤"],
  tone: ["색조 톤", "トーン", "色调"],
  cat: ["고양이", "猫", "猫"],
  dog: ["강아지 개", "犬", "狗"],
  monkey: ["원숭이", "猿 サル", "猴子"],
  gorilla: ["고릴라 원숭이", "ゴリラ 猿", "大猩猩 猴子"],
  orangutan: ["오랑우탄 원숭이", "オランウータン 猿", "猩猩 猴子"],
  bird: ["새", "鳥", "鸟"],
  flower: ["꽃", "花", "花"],
  tree: ["나무", "木", "树"],
  sun: ["해 태양", "太陽", "太阳"],
